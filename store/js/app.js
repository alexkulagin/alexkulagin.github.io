...
(function(factory) {
  ...
  NanoScroll = (function() {
    ...
    NanoScroll.prototype.preventScrolling = function(e, direction) {
      console.log("preventScrolling", e);
      if (!this.isActive) {
        return;
      }
      if (e.type === DOMSCROLL) {
...
jQuery(function($)
{
	...
	$('.cart-tint, .cart-header, .cart-background').bind('touchmove', function(e){e.preventDefault()});


	// mini app

	var btn = $('.cart-tabs li');
		btn.click(BtnOnClick);

	var currentState = "current-section__cart";
	$('.cart-wrapper').addClass("current-section__cart");

	function BtnOnClick() {
		var el = $(this);
		changeState(el.attr("class"));
	}
	...
	function changeState(state) {
		...
		if (newState == "current-section__cart" || newState == "current-section__favorites") {
			$('.cart-wrapper').addClass(newState);
		}
